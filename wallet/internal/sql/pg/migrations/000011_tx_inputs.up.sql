...
CREATE TABLE tx_inputs (
    ...
    -- Composite primary key keeps the input row wallet-scoped, matching the
    -- other wallet-scoped child tables.
    CONSTRAINT pidx_tx_inputs PRIMARY KEY (wallet_id, id),
