...
WHERE
    ...
    AND (
        ...
        OR (
            acc.is_derived
            AND dacct.account_number = sqlc.narg('account_number')::BIGINT
        )
    )
    AND (
        ...
        OR (
            sqlc.narg('account_name')::TEXT = 'imported'
...
WHERE
    ...
    AND (
        ...
        OR sqlc.narg('coinbase_maturity')::INTEGER = 0
