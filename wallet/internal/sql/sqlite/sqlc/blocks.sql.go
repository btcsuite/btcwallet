...
// increment.
func (q *Queries) GetBlockByHeight(ctx context.Context, blockHeight int64) (GetBlockByHeightRow, error) {
...
func (q *Queries) PruneStaleSyncBlock(ctx context.Context, blockHeight int64) error {
