...
// TestWalletVaultKnownVectorMasterKey verifies that each fixed passphrase and
// serialized parameters derive the expected master private crypto key.
func TestWalletVaultKnownVectorMasterKey(t *testing.T) {
	t.Parallel()
...
// TestWalletVaultKnownVectorUnlockAndDecrypt verifies the full persisted-secret
...
// wallet state.
func TestWalletVaultKnownVectorUnlockAndDecrypt(t *testing.T) {
	t.Parallel()
