// Package sqlite implements the manager transaction store with SQLite.
package sqlite
...
func (q *queryAdapter) AdvanceWalletSyncedTo(ctx context.Context,
	...
	return q.queries.AdvanceWalletSyncedTo(
		ctx, sqlitedb.AdvanceWalletSyncedToParams{
...
func (q *queryAdapter) ListMinedTransactionsFromHeight(
	...
	rows, err := q.queries.ListMinedTransactionsFromHeight(
		ctx, sqlitedb.ListMinedTransactionsFromHeightParams{
			WalletID: walletID,
			Height:   int64(height),
		},
	)
...
func (q *queryAdapter) GetUnminedTransactionID(ctx context.Context,
	...
	row, err := q.queries.GetUnminedTransactionByHash(
		ctx, sqlitedb.GetUnminedTransactionByHashParams{
			WalletID: walletID,
			TxHash:   hash,
		},
	)
...
func (q *queryAdapter) DeleteCreditSpendsBySpendingTx(
	...
	return q.queries.DeleteCreditSpendsBySpendingTx(
		ctx, sqlitedb.DeleteCreditSpendsBySpendingTxParams{
			WalletID:     walletID,
...
func (q *queryAdapter) DetachMinedTransaction(ctx context.Context, walletID,
	...
	return q.queries.DetachMinedTransaction(
		ctx, sqlitedb.DetachMinedTransactionParams{
			WalletID: walletID,
			ID:       transactionID,
		},
	)
...
func (q *queryAdapter) SetActiveCreditIncidence(ctx context.Context, walletID,
	...
	return q.queries.SetActiveCreditIncidence(
		ctx, sqlitedb.SetActiveCreditIncidenceParams{
			WalletID: walletID,
			ID:       creditID,
		},
	)
...
func (q *queryAdapter) ListUnminedSpendersByPrevHash(
	...
	rows, err := q.queries.ListUnminedSpendersByPrevHash(
		ctx, sqlitedb.ListUnminedSpendersByPrevHashParams{
			WalletID:   walletID,
			PrevTxHash: hash,
		},
	)
...
func (q *queryAdapter) DeleteTransaction(ctx context.Context, walletID,
	...
	return q.queries.DeleteTransactionByID(
		ctx, sqlitedb.DeleteTransactionByIDParams{
			WalletID: walletID,
			ID:       transactionID,
		},
	)
