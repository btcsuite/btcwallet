...
// accountListQueries adapts PostgreSQL account listing queries to the shared
...
func (p accountListQueries) ListByScope(ctx context.Context,
	query db.ListAccountsQuery) ([]db.AccountInfo, error) {
...
func (p accountListQueries) ListByName(ctx context.Context,
	query db.ListAccountsQuery) ([]db.AccountInfo, error) {
...
// needed.
func (p accountListQueries) AttachAccountBalances(ctx context.Context,
