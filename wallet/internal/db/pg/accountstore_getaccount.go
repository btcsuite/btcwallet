...
func (p accountGetQueries) GetAccountByNumber(ctx context.Context,
	query db.GetAccountQuery) (*db.AccountInfo, error) {
...
func (p accountGetQueries) GetAccountByName(ctx context.Context,
	query db.GetAccountQuery) (*db.AccountInfo, error) {
...
func (p accountGetQueries) AttachAccountBalance(ctx context.Context,
