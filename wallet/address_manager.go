...
// newAddressByType derives and registers the next address of addrType for
// GetUnusedAddress inside its accepted request.
func (w *Wallet) newAddressByType(ctx context.Context, accountName string,
...
// If all previously derived addresses have been used, this method derives the
// next one.
...
func (w *Wallet) handleGetUnusedAddress(r getUnusedAddressReq) {
	...
	responseAddr, responseErr := w.newAddressByType(
