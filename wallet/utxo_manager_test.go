...
func TestListUnspent(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			// Check that the correct addresses are returned. We do this
			// by creating a map of the returned addresses and
			// comparing it to the expected map. This ensures that all
			// expected addresses are present and there are no
			// duplicates.
...
// and that it returns the expected error when the UTXO is not found.
