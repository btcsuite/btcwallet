...
func (m *mockTxStore) Balance(ns walletdb.ReadBucket, minConf int32,
	...
	return args.Get(0).(btcutil.Amount), args.Error(1) //nolint:forcetypeassert
}
...
func (m *mockTxStore) ListLockedOutputs(
	...
	args := m.Called(ns)
	return args.Get(0).([]*wtxmgr.LockedOutput), args.Error(1) //nolint:forcetypeassert
}
...
func (m *mockTxStore) LockOutput(ns walletdb.ReadWriteBucket, id wtxmgr.LockID,
	...
	return args.Get(0).(time.Time), args.Error(1) //nolint:forcetypeassert
}
