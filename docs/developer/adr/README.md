...
- [ADR 0013: Normalized Account and Address Identity](./0013-normalized-account-address-identity.md) - Normalizes SQL account/address identity into parent identity tables plus subtype tables, avoiding fake BIP44 account numbers and the stored raw-import account bucket.
