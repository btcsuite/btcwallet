...
func (c *MempoolChain) Rescan(*chainhash.Hash, []address.Address,
...
// SubmitPackage implements the chain.Interface interface. The fake performs
// no package relay and simply returns an empty result.
func (c *MempoolChain) SubmitPackage(_ []*wire.MsgTx,
