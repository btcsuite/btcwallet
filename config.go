...
type config struct {
	...
	RPCMaxClients int64    `long:"rpcmaxclients" description:"Maximum number of concurrent active RPC clients allowed"`
	WSMaxClients  int64    `long:"wsmaxclients" description: "Maximum number of concurrent active WS clients allowed"`
...
func loadConfig() (*config, []string, error) {
	...
	cfg := config{
		...
		WSMaxClients:  defaultWSMaxClients,
	}
